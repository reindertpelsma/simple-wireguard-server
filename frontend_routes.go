  ...
  <main>
    <section class="hero">
      <div style="display:grid;gap:22px">
        <span class="eyebrow">uwgsocks-ui</span>
        <h1>Only the lock is public.</h1>
        <p>This lightweight login page is served before the dashboard bundle. After authentication, the full control surface is loaded behind your session cookie.</p>
      </div>
      <div class="tiles">
        <div class="tile">Peers</div>
        <div class="tile">ACLs</div>
        <div class="tile">Traffic shaping</div>
      </div>
    </section>
    <section class="card">
      ...
      <div style="display:grid;gap:8px;margin-top:14px">
        <h2>Sign in</h2>
        <p>Use your username and password. If two-factor auth is enabled, the next step asks for the 6-digit code.</p>
      </div>
      <form id="login-form">
